...
; ;ic:1:  _entry($2) :
; ;ic:2: 	proc __gstack_test [k1 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{void function    ( ) }
...
; ;ic:4:  _return($1) :
; ;ic:5: 	eproc __gstack_test [k1 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{void function    ( ) }
; ; Starting pCode block
; ;ic:1:  _entry($2) :
; ;ic:2: 	proc __gstack_init [k1 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{void function    ( ) }
...
; ;ic:4:  _return($1) :
; ;ic:5: 	eproc __gstack_init [k1 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{void function    ( ) }
; ; Starting pCode block
; ;ic:1:  _entry($2) :
; ;ic:2: 	proc __gstack_overflow_default [k1 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{void function    ( ) }
...
; ;ic:4:  _return($1) :
; ;ic:5: 	eproc __gstack_overflow_default [k1 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{void function    ( ) }
