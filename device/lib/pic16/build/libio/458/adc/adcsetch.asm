...
; ;ic:1:  _entry($2) :
; ;ic:2: 	proc _adc_setchannel [k1 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{void function    ( unsigned-char) }
...
; ;ic:4:  _return($1) :
; ;ic:5: 	eproc _adc_setchannel [k1 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{void function    ( unsigned-char) }
