...
; ;ic:8: 	if iTemp2 [k5 lr7:35 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{unsigned-char}[r0x03 ] == 0 goto _whilebreak_0($19)
	MOVF	r0x03, W
	BZ	_00123_DS_
; ;ic:9: 	iTemp3 [k7 lr9:10 so:0]{ ia0 a2p0 re0 rm1 nos0 ru0 dp0}{volatile-unsigned-bitfield {3,1} near* }[remat] = &[_SSPCON1bits [k6 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{volatile-struct __00010272}]
...
;	.line	13; i2cwrites.c	I2C_IDLE();
	...
	ANDWF	_SSPCON2, W
	MOVWF	r0x04
; ;ic:20: 	iTemp10 [k18 lr20:21 so:0]{ ia0 a2p0 re0 rm1 nos0 ru0 dp0}{volatile-unsigned-bitfield {2,1} near* }[remat] = &[_SSPSTATbits [k17 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{volatile-struct __00010274}]
...
; ;ic:25: 	if iTemp15 [k24 lr24:25 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{char}[r0x04 ] != 0 goto _whilecontinue_1($3)
	MOVF	r0x04, W
	BNZ	_00107_DS_
; ;ic:26: 	iTemp16 [k26 lr26:27 so:0]{ ia0 a2p0 re0 rm1 nos0 ru0 dp0}{volatile-unsigned-bitfield {6,1} near* }[remat] = &[_SSPCON2bits [k25 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{volatile-struct __00010270}]
...
;	.line	15; i2cwrites.c	return (-2);
	...
	BRA	_00124_DS_
; ;ic:31:  _iffalse_3($15) :
; ;ic:32: 	iTemp19 [k31 lr32:33 so:0]{ ia0 a2p0 re0 rm1 nos0 ru0 dp0}{volatile-unsigned-bitfield {3,1} near* }[remat] = &[_PIR1bits [k30 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{volatile-struct __00010121}]
...
;	.line	19; i2cwrites.c	SSPBUF = *ptr;
	MOVFF	r0x03, _SSPBUF
; ;ic:36: 	iTemp23 [k37 lr36:37 so:0]{ ia0 a2p0 re0 rm1 nos0 ru0 dp0}{volatile-unsigned-bitfield {4,1} near* }[remat] = &[_SSPCON1bits [k6 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{volatile-struct __00010272}]
...
; ;ic:41: 	iTemp25 [k40 lr41:42 so:0]{ ia0 a2p0 re0 rm1 nos0 ru0 dp0}{volatile-unsigned-bitfield {3,1} near* }[remat] = &[_PIR1bits [k30 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{volatile-struct __00010121}]
...
; ;ic:45: 	iTemp28 [k44 lr45:46 so:0]{ ia0 a2p0 re0 rm1 nos0 ru0 dp0}{volatile-unsigned-bitfield {2,1} near* }[remat] = &[_SSPSTATbits [k17 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{volatile-struct __00010274}]
...
; ;ic:49: 	iTemp31 [k48 lr49:50 so:0]{ ia0 a2p0 re0 rm1 nos0 ru0 dp0}{volatile-unsigned-bitfield {0,1} near* }[remat] = &[_SSPSTATbits [k17 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{volatile-struct __00010274}]
