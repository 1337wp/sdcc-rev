...
S_crt0iz___entry	code	0X000000
__entry:
; ;ic:3: inline
	goto __startup 
; ;ic:4:  _return($1) :
...
; ;ic:5: 	iTemp0 [k3 lr5:5 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{void} = call __do_cinit [k2 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{void function    ( ) }
;	.line	107; crt0iz.c	_do_cinit();
	CALL	__do_cinit
; ;ic:6: 	iTemp1 [k5 lr6:6 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{void} = call _main [k4 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{void function    ( ) }
;	.line	110; crt0iz.c	main();
	CALL	_main
; ;ic:8:  loop($1) :
; ;ic:9: 	 goto loop($1)
_00109_DS_:
;	.line	114; crt0iz.c	goto loop;
	BRA	_00109_DS_
; ;ic:10:  _return($2) :
; ;ic:11: 	eproc __startup [k1 lr0:0 so:0]{ ia0 a2p0 re0 rm0 nos0 ru0 dp0}{void function    ( ) }
