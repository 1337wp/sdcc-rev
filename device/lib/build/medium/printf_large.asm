...
;	printf_large.c:671: unsigned char MEM_SPACE_BUF_PP *pstore = &store[5];
	mov	r5,#(__print_format_store_4_22 + 0x0005)
...
;	printf_large.c:706: do {
	mov	__print_format_sloc0_1_0,r5
	mov	r2,#0x00
00190$:
...
;	printf_large.c:715: *pstore = (value.byte[4] << 4) | (value.byte[4] >> 4) | *pstore;
	...
	swap	a
	mov	r6,a
	mov	r0,__print_format_sloc0_1_0
	movx	a,@r0
	mov	r7,a
	orl	a,r6
	mov	r0,__print_format_sloc0_1_0
...
;	printf_large.c:716: pstore--;
	...
	mov	r5,__print_format_sloc0_1_0
	sjmp	00189$
00188$:
...
;	printf_large.c:724: } while( value.ul );
	...
	inc	r0
	movx	a,@r0
	mov	(__print_format_sloc1_1_0 + 3),a
	mov	a,__print_format_sloc1_1_0
	orl	a,(__print_format_sloc1_1_0 + 1)
	orl	a,(__print_format_sloc1_1_0 + 2)
	orl	a,(__print_format_sloc1_1_0 + 3)
	jnz	00190$
...
;	printf_large.c:802: if (left_justify)
	jb	__print_format_left_justify_1_1,00402$
	ljmp	00239$
00402$:
